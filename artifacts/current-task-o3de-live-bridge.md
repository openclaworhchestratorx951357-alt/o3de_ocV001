...
- immediate next artifact: MCP exposure for `entity_find` or next adjacent read-only entity inspection slice
...
Advance from bridge-side `entity_find` implementation to MCP exposure or the next adjacent read-only entity inspection slice.
