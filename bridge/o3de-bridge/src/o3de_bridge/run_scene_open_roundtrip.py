"""WSL-side helper to stage a narrow approval-gated scene_open request and read back the response."""
...
from .models import RequestMeta, SceneOpenRequest

BRIDGE_ROOT = Path("/mnt/c/Users/topgu/O3DEBridge")
DEFAULT_REQUEST_PREFIX = "scene-open-roundtrip"
DEFAULT_APPROVAL_TOKEN = "approved-scene-open-v1"
DEFAULT_PROJECT_ID = "McpSandbox"
DEFAULT_SCENE_NAME = "TestLevel01"
...
def build_request(
    ...
    approval_token: str = DEFAULT_APPROVAL_TOKEN,
) -> SceneOpenRequest:
