"""WSL-side helper to stage a narrow approval-gated entity_create request and read back the response."""
...
from .models import ComponentSpec, EntityCreateRequest, RequestMeta

BRIDGE_ROOT = Path("/mnt/c/Users/topgu/O3DEBridge")
DEFAULT_REQUEST_PREFIX = "entity-create-roundtrip"
DEFAULT_APPROVAL_TOKEN = "approved-entity-create-v1"
DEFAULT_PROJECT_ID = "McpSandbox"
DEFAULT_SCENE_NAME = "TestLoevel01"
DEFAULT_ENTITY_NAME = "bridge_entity_01"
...
def build_request(request_id: str | None = None, approval_token: str = DEFAULT_APPROVAL_TOKEN) -> EntityCreateRequest:
