"""WSL-side helper to stage a narrow scene_validate request and read back the response."""
...
from .models import EntityExpectation, RequestMeta, SceneValidateRequest

BRIDGE_ROOT = Path("/mnt/c/Users/topgu/O3DEBridge")
DEFAULT_REQUEST_PREFIX = "scene-validate-roundtrip"
DEFAULT_PROJECT_ID = "McpSandbox"
DEFAULT_SCENE_NAME = "TestLoevel01"
DEFAULT_ENTITY_NAME = "test entity"
...
def build_request(request_id: str | None = None) -> SceneValidateRequest:
    resolved_request_id = request_id or make_request_id()
    return SceneValidateRequest(
        meta=RequestMeta(
