...
def test_validate_request_model_accepts_entity_descendants_with_parent_lookup() -> None:
    request = EntityDescendantsRequest(
        meta=RequestMeta(
            request_id="req-2018",
            tool_name="entity_descendants",
            dry_run=False,
            approval_token=None,
            timestamp=None,
        ),
    ...
    validate_request_model("entity_descendants", request)
